    ...
    <div class="container" id="panel">
        ...
        <div class="row">
            <div class="col-md-6 offset-md-3" style="background-color: white; padding: 20px; box-shadow: 10px 10px 5px #888;">
                ...
                <hr>
                <a href="QR.php">Generate One More...</a>
                <a href="generate.php?text=<?php echo $_GET['text']?>" style="margin-left:250px" download="Student">Download</a>
                <a href="Records.php" class="btn btn-warning btn-block">Go Back to Records</a>
            </div>
